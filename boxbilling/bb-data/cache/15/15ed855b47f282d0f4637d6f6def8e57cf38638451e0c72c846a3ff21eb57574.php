...
/* partial_menu.phtml */
class __TwigTemplate_a52444f649eeaed51fbdce5b9fe64aaa986edcb9fc62720752d367246828c3ea extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% for location,group in navigation %}
    ...
    {% endif %}
{% endfor %}
</ul>", "partial_menu.phtml", "/home/fendi/Documents/php-workspace/BoxBilling/bb-themes/admin_default/html/partial_menu.phtml");
    }
}
