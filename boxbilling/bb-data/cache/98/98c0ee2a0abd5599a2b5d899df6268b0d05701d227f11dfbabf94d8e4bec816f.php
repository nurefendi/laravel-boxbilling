...
class __TwigTemplate_f578f1b904dffa1662485bcc3fd5ef53c5dab4361b3e0d92aa089711c4acc703 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"tabs_container\">
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["license"] ?? null), "expires_at", [], "any", false, false, false, 54)) {
            ...
            echo "</td>
                        <td align=\"right\">";
            // line 57
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["license"] ?? null), "expires_at", [], "any", false, false, false, 57), "html", null, true);
            echo "</td>
                    </tr>
                    ";
        }
            ...
            <table class=\"tableStatic wide\">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align=\"right\">{{ license.expires_at }}</td>
                    </tr>
                    {% endif %}
...
{% endblock %}", "mod_system_index.phtml", "/home/fendi/Documents/php-workspace/BoxBilling/bb-themes/admin_default/html/mod_system_index.phtml");
    }
}
